...
static const char *fonts[]          	  = { "Iosevka:size=10", "Symbols Nerd Font:size=12" };
...
/* ewwcmd */
static const char *ewwcmd[] = { "/home/bugs/.config/eww/dashboard/launch_dashboard", NULL };
